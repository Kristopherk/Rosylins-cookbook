...
<html lang="en">
   ...
   <h2 class="text-center text-success">Recipe titles (alphabetical)</h2>
   ...
   <?php foreach($recipes as $recipe): ?>    
      ...
      <div class="row">   
         <div  class=" text-center input">
            ...
            <form class="form-group" action="recipes.php" method="POST">
               
               <input type="submit" class="click_title form-control-sm" name="title" value="<?php echo htmlspecialchars($recipe['title']); ?>" >
